    ...
    return (
        <div className="intro">
            ...
            <p className="small">
               ...
               the orientation week. We're currently working on making this page secure. In the meantime, you can you this link https://digitalmediabremen.github.io/hej/ for secure connection.
