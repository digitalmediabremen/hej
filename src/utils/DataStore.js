...
export default class DataStore {
  ...
  static studentNames = ["Amin" , "Sinan" , "Leon" , "Oskar" , "Lilou" , "Lucia" , "Lucy" , "Çagla Ecrin" , "Jule" , "Jürgen" , "Greta" , "Timon" , "Emma" , "Skrollan-Mira" , "Imke" , "Greta" , "Vanessa" , "Elifnur" , "Haram" , "Nico" , "Karoline" , "Milan" , "Varela" , "Felix" , "Nick" , "Aparajita" , "Philipp" , "Kanong" , "Vanessa Emilie" , "Laura" , "Ayham" , "Janina" , "Lilli" , "Moritz" , "Mieke" , "Jan" , "Maik" , "Amal" , "Jonas" , "Donna" , "Pauline" , "Igor" , "Loan" , "Adeline Michelle" , "Batuhan" , "Hevdi" , "Malte" , "Ervina" , "Sarah" , "Leiken" , "Paul" , "Lena" , "Myroslava" , "Lars" , "Nazmul" , "Lenya" , "Vishnu" , "Lea" , "Lilli" , "Danushka" , "Satomi" , "Henrik" , "Rojda" , "Zameer Khan Imtiaz" , "Awais" , "Katharina" , "Cantufan" , "Christian" , "Djamila" , "Aleksandr" , "Julian" , "Lilith" , "Wiktoria" , "Josea" , "Sophia" , "Gerda" , "Mi-El" , "Nicolas" , "Maya" , "Yuliya" , "Maximilian" , "Srujana" , "Melissa" , "Reyyan Melis" , "Jelte" , "Sebastian Gabriel" , "Jana" , "Paulina" , "Mehrdad" , "Kira" , "Rebecca" , "Sarah Islam" , "Linda" , "Felix" , "Angelo" , "Marlene" , "Md Ariful Islam" , "Gheorghe" , "Jenciya" , "Tabea" , "Zuzanna" , "Jan Habbo" , "Aaron" , "Anna" , "Richard" , "Fynn" , "Yeasir Arafat" , "Clark" , "Joana" , "Arne" , "Alban" , "Pascal" , "Marina" , "Thomas" , "Jannes" , "Lilli" , "Paula Sophie" , "Timo" , "Yoriko" , "Chen" , "Yoona" , "Manuel" , "Nico" , "Shohei" , "Md Sabbir" , "Alisha" , "Jana" , "Xin" , "Minh Thu" , "Ashley-Celestina , "Felix" , "Simon" , "Luis", "Noah", "Carlotta" , "Lina" , "Alma" , "LaraNina" , "Noel" , "Rashmi" , "Anny" , "Elena" , "Katharina" , "Carlotta" , "Simon" , "Yufan" , "Gizem" , "Darja" , "Linea" , "Gunnar"]
