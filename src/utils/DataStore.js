...
export default class DataStore {
  ...
  static studentNames = ["Leila","Timm","Anna","Farzad","Aladham","Qianxun","Yongliang","Chi Him","Joshua","Xiangyu","Vassilissa","Parastou","Anastasiia","Charley","Ivett","Hyejoon","Mihye","Cuong Huy","Hiu Yan","Sangbong","Juan","Nilufer","Ziyafettin","Kazuki","Julia","Jorin","Joshua","Viacheslav","Feodor","Soo Hyun","Soumya","Alberto","Annelena","Aysegül","Juan","Hannah","Mahmoud","Lucca","Julia","Erik","Paul","Kairaba","Md Rabiul","Marcel","Salma Ferdous","Sophie","Henri","Kornél","Md. Soleman","Hyunwoo","Valea","Mira","Cindy","Jessica","Aklima","Dominik","Jaysun","Kai","Sana","Tammo","Lea","King Wai","Magnus"]
